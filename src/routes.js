...
export const routes = [
    ...
    { path: '/como-funciona', component: ComoFunciona, titulo: 'Por onde começar?', detalhe: 'Vou te explicar como funciona!' },
    { path: '/tela-pesquisa-grupo', component: TelaGrupo, titulo: 'Grupos', detalhe: 'O que estão comprando?' },
    { path: '/duvidas', titulo: 'Dúvidas', component: Duvidas, detalhe: 'Em que pode ajudá-lo?' },
    { path: '/contato', titulo: 'Contato', component: Contato, detalhe: 'Envie sua mensagem' },
    { path: '/detalhe-grupo', component: DetalheGrupo, titulo: 'DetalheGrupo', detalhe: 'O que está vendendo?' },
